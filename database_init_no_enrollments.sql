-- Database Clean Initialization Script for Timetable Management System (No Student Enrollments)
-- This script will drop existing tables and recreate them with fresh data
-- Students are created but not enrolled in any courses
...
-- Student users (5 students) - NOT ENROLLED IN ANY COURSES YET
...
-- 6. NO STUDENT ENROLLMENTS - Students are created but not enrolled in any courses
-- This section is intentionally left empty to allow manual enrollment through the admin panel
...
SELECT 'Database clean initialization completed successfully! Students created but not enrolled in any courses.' as status;