  ...
  const roles = [
    {
      id: "admin",
      title: "Admin",
      description: "Manage subjects, faculty, rooms and generate timetables",
      icon: UserCog,
      color: "bg-primary",
  route: "/admin"
    },
    {
      id: "student", 
      title: "Student",
      description: "Enroll in subjects and view your personalized timetable",
      icon: GraduationCap,
      color: "bg-secondary", 
      route: "/student"
    },
    {
      id: "staff",
      title: "Staff",
      description: "View your assigned classes and teaching schedule",
      icon: Users,
      color: "bg-accent",
      route: "/staff"
    }
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">AI Timetable Management System</h1>
